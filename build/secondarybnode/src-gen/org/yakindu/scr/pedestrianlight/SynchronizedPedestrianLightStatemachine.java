...
/**
 * Runnable wrapper of PedestrianLightStatemachine. This wrapper provides a thread-safe
 * instance of the state machine.
 * 
 * Please report bugs and issues...
 */

public class SynchronizedPedestrianLightStatemachine implements IPedestrianLightStatemachine {
	 ...
	 * implicitly.
	 */
	protected PedestrianLightStatemachine statemachine = new PedestrianLightStatemachine();
	...
	public SynchronizedPedestrianLightStatemachine() {
	...
	protected ITimer timerProxy = new ITimer() {
		...
		public void setTimer(ITimerCallback callback, int eventID, long time,
				boolean isPeriodic) {
			externalTimer.setTimer(SynchronizedPedestrianLightStatemachine.this, eventID, time, isPeriodic);
		}
		
		@Override
		public void unsetTimer(ITimerCallback callback, int eventID) {
			externalTimer.unsetTimer(SynchronizedPedestrianLightStatemachine.this, eventID);
		}
	};
