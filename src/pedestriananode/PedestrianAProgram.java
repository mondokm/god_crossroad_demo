...
import hu.bme.mit.gamma.impl.pedestriananode.PedestrianANode;
...
public class PedestrianAProgram {
	...
	public void run() {
		...
		node=new PedestrianANode();
		node.getPedestrianAOutput().registerListener(new LightsListener());
